...
public class RNTCodeScannerViewManager extends SimpleViewManager<CodeScanner> {
    ...
    @Override
    protected CodeScanner createViewInstance(final ThemedReactContext reactContext) {
        final CodeScanner scanner = new CodeScanner(reactContext);
        ...
        scanner.init(
                ...
                new CodeScannerCallback() {
                    @Override
                    public void onScanSuccess(@NotNull String s) {
    ...
    public void setTitle(CodeScanner view, String title) {
